...
public interface TimeshareCompanyService {
    TimeshareCompanyDto createTimeshareCompany(TimeshareCompanyDto timeshareCompanyDto) throws EntityAlreadyExist, UserDoesNotExistException, ErrMessageException, OptionalNotFoundException;
